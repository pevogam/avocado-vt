# pylint: disable=consider-using-f-string,differing-param-doc,docstring-first-line-empty,import-error,method-hidden,missing-param-doc,missing-raises-doc,missing-return-doc,no-else-return,no-self-use,pointless-string-statement,property-with-parameters,too-many-instance-attributes,too-many-public-methods,unused-argument,use-implicit-booleaness-not-comparison-to-string,use-implicit-booleaness-not-comparison-to-zero,useless-object-inheritance,wrong-import-order
